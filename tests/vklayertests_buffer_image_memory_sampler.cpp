...
TEST_F(VkLayerTest, SyncCopyOptimalMultiPlanarHazards) {
    // TODO: Add code to enable sync validation
    // Enable KHR multiplane req'd extensions
    bool mp_extensions = InstanceExtensionSupported(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME,
                                                    VK_KHR_GET_MEMORY_REQUIREMENTS_2_SPEC_VERSION);
...
TEST_F(VkLayerTest, SyncCopyLinearImageHazards) {
    // TODO: Add code to enable sync validation
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkLayerTest, SyncCopyLinearMultiPlanarHazards) {
    // TODO: Add code to enable sync validation
    // Enable KHR multiplane req'd extensions
    bool mp_extensions = InstanceExtensionSupported(VK_KHR_GET_PHYSICAL_DEVICE_PROPERTIES_2_EXTENSION_NAME,
                                                    VK_KHR_GET_MEMORY_REQUIREMENTS_2_SPEC_VERSION);
...
TEST_F(VkLayerTest, SyncCopyBufferImageHazards) {
    // TODO: Add code to enable sync validation
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkLayerTest, SyncBlitImageHazards) {
    // TODO: Add code to enable sync validation
    ASSERT_NO_FATAL_FAILURE(Init());
...
TEST_F(VkLayerTest, SyncRenderPassBeginTransitionHazard) {
    ASSERT_NO_FATAL_FAILURE(InitFramework(m_errorMonitor));
    ASSERT_NO_FATAL_FAILURE(InitState());
...
TEST_F(VkLayerTest, SyncCmdClear) {
    ASSERT_NO_FATAL_FAILURE(Init(nullptr, nullptr, VK_COMMAND_POOL_CREATE_RESET_COMMAND_BUFFER_BIT));
...
TEST_F(VkLayerTest, SyncCmdQuery) {
